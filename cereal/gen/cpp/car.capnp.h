...
struct CarParams::LateralLQRTuning {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(9d151e3f28616a12, 1, 7)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
public:
  ...
  inline bool hasScaleBP() const;
  inline  ::capnp::List<float>::Reader getScaleBP() const;

  inline bool hasScaleV() const;
  inline  ::capnp::List<float>::Reader getScaleV() const;
...
public:
  ...
  inline bool hasScaleBP();
  inline  ::capnp::List<float>::Builder getScaleBP();
  inline void setScaleBP( ::capnp::List<float>::Reader value);
  inline void setScaleBP(::kj::ArrayPtr<const float> value);
  inline  ::capnp::List<float>::Builder initScaleBP(unsigned int size);
  inline void adoptScaleBP(::capnp::Orphan< ::capnp::List<float>>&& value);
  inline ::capnp::Orphan< ::capnp::List<float>> disownScaleBP();

  inline bool hasScaleV();
  inline  ::capnp::List<float>::Builder getScaleV();
  inline void setScaleV( ::capnp::List<float>::Reader value);
  inline void setScaleV(::kj::ArrayPtr<const float> value);
  inline  ::capnp::List<float>::Builder initScaleV(unsigned int size);
  inline void adoptScaleV(::capnp::Orphan< ::capnp::List<float>>&& value);
  inline ::capnp::Orphan< ::capnp::List<float>> disownScaleV();
...
inline bool CarParams::LateralLQRTuning::Reader::hasScaleBP() const {
  return !_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline bool CarParams::LateralLQRTuning::Builder::hasScaleBP() {
  return !_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline  ::capnp::List<float>::Reader CarParams::LateralLQRTuning::Reader::getScaleBP() const {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List<float>::Builder CarParams::LateralLQRTuning::Builder::getScaleBP() {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void CarParams::LateralLQRTuning::Builder::setScaleBP( ::capnp::List<float>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List<float>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline void CarParams::LateralLQRTuning::Builder::setScaleBP(::kj::ArrayPtr<const float> value) {
  ::capnp::_::PointerHelpers< ::capnp::List<float>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List<float>::Builder CarParams::LateralLQRTuning::Builder::initScaleBP(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), size);
}
inline void CarParams::LateralLQRTuning::Builder::adoptScaleBP(
    ::capnp::Orphan< ::capnp::List<float>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List<float>>::adopt(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List<float>> CarParams::LateralLQRTuning::Builder::disownScaleBP() {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}

inline bool CarParams::LateralLQRTuning::Reader::hasScaleV() const {
  return !_reader.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS).isNull();
}
inline bool CarParams::LateralLQRTuning::Builder::hasScaleV() {
  return !_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS).isNull();
}
inline  ::capnp::List<float>::Reader CarParams::LateralLQRTuning::Reader::getScaleV() const {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::get(_reader.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline  ::capnp::List<float>::Builder CarParams::LateralLQRTuning::Builder::getScaleV() {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::get(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline void CarParams::LateralLQRTuning::Builder::setScaleV( ::capnp::List<float>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List<float>>::set(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), value);
}
inline void CarParams::LateralLQRTuning::Builder::setScaleV(::kj::ArrayPtr<const float> value) {
  ::capnp::_::PointerHelpers< ::capnp::List<float>>::set(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List<float>::Builder CarParams::LateralLQRTuning::Builder::initScaleV(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::init(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), size);
}
inline void CarParams::LateralLQRTuning::Builder::adoptScaleV(
    ::capnp::Orphan< ::capnp::List<float>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List<float>>::adopt(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List<float>> CarParams::LateralLQRTuning::Builder::disownScaleV() {
  return ::capnp::_::PointerHelpers< ::capnp::List<float>>::disown(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
